    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
                {/* navlink adds "active" to class name when we click a particular link
                we can use this keyword to perform actions
                so by default we will hide the hr tags
                and in index .css we will manipulate the hidden property based on onhover */}
            ...
            {/* for this div we will use dynamic classname
            which is we will use state variable to change the class name */}
